...
const CONTENT = {
  fr: {
    ...
    cgvBody2: "La réservation est transmise à l’hébergeur sans paiement en ligne dans la plateforme. MyBestBooking ne demande pas de données de carte bancaire dans le tunnel de réservation.",
  ...
  en: {
    ...
    cgvBody2: "Bookings are sent to the host without online payment in the platform. MyBestBooking does not ask for card details in the booking flow.",
